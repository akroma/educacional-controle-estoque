			...
			if($model->save()){
				...
				if (isset($_POST['CategoriaProduto'])) {
					...
					foreach ($categorias as $key => $categoria_id){
						...
						$CategoriaProduto->attributes = array(
				...
				$Controle->attributes = array(
					"funcionario_nif"=>$_POST['Controle']['funcionario_nif']
				);
				$Controle->save();
				...
				$ProdutoControle->attributes = array(
					"produto_id"=>$model->id,
					"controle_id"=>$Controle->id,
					"quantidade"=>$_POST['ProdutoControle']['quantidade']
				);
