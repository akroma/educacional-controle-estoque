...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div id="cartuchoFormTable">
		<h3>CARTUCHOS A SEREM RETIRADOS</h3>
		<table>
			<thead>
				<tr>
					<th>NOME</th>
	...
	<div class="group selectize_funcionario_nif">
		...
		<select class="funcionario_nif" name="Controle[funcionario_nif]" id="Controle_funcionario_nif" ></select>
	...
	<div class="group buttons">
		<?php echo CHtml::submitButton('Retirar Cartuchos',array('class'=>"btn btn-success")); ?>
	</div>
